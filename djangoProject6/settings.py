...
SECRET_KEY = 'django-insecure-0w&$wp6+ggunszllq6-6%oxzyzw%9v&xzt%$@!v5^21r*%8cf$'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SoftwareEngi',  # change to your database name
        'USER': 'postgres',  # change to your username
        'PASSWORD': '1234',  # change to your user password
        'HOST': 'localhost',
